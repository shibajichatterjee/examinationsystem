package com.rest.examinationsystem.assessment.item.options.controller;
...
@RestController
@RequestMapping(value = "/assesmentItemOption")
@Transactional
public class AssesmentItemOptionController {

	@Autowired
	private AssesmentItemOptionService assesmentItemOptionService;

	@RequestMapping(value = "/createAssesmentItemOption", method = RequestMethod.POST)
	public ResponseEntity createAssesmentItemOption(@RequestHeader("API-KEY") String apiKey)
	...
	@RequestMapping(value = "/getAssesmentItemOptionById", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/updateAssesmentItemOption", method = RequestMethod.POST)
