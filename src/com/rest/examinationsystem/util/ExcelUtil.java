...
public class ExcelUtil {
	...
	public Map<Integer, Map<Integer, byte[]>> getImageIndex(InputStream inputStream) throws IOException {
		Map<Integer, Map<Integer, byte[]>> pictureMap = new HashMap<>();
		//FileInputStream fileInputStream = new FileInputStream(path);
	...
	public Map<AssesmentItemDto, List<AssesmentItemOptionDto>>   convertExcelToItemObject(String filePath) throws IOException {
